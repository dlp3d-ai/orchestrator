...
class SenseNovaClassificationClient(ClassificationAdapter):
    """Classification client for SenseNova API.

    This client provides text classification functionality through SenseNova
    ...
    def __init__(
        ...
        """Initialize the SenseNova classification client.
        ...
        try:
            ...
            messages = [
                ...
                },
                {
                    "role": "user",
                    "content": [
                        {"type": "text", "text": f"<user_input>: {text}"},
                    ],
                },
            ]
            ...
            self.logger.error(f"Classification error: {error_msg}")
