...
class SenseNovaReactionClient(ReactionAdapter):
    """SenseNova reaction client using SenseNova API for emotion and motion
    analysis.

    This client uses SenseNova API to analyze conversation context and generate
    ...
    def __init__(
        ...
        """Initialize the SenseNova reaction client.
        ...
        Args:
            ...
            proxy_url (Union[None, str], optional):
                The proxy URL for the SenseNova API.
    ...
    async def get_reaction_delta(
        ...
        Args:
            ...
            response_format (Optional[Dict[str, Any]], optional):
                JSON schema format for structured response. Not supported by SenseNova API.
                Defaults to None.
        ...
        if not api_keys.get("sensenova_ak") or not api_keys.get("sensenova_sk"):
